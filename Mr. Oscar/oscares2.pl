...
pron_int(s-_,quem) --> ['Quem'];[quem].
pron_int(s-_,qual) --> ['Qual'];[qual].
pron_int(p-_,qual) --> ['Quais'];[quais].
pron_int(_,que) --> ['Que'];[que].
pron_int(p-m,quant) --> ['Quantos'];[quantos].
pron_int(p-f,quant) --> ['Quantas'];[quantas].
